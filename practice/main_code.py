...
def preprocessData():
    ...
    return features_train, features_test, features_train_transformed, features_test_transformed, labels_train, labels_test, vectorizer


def main():
    original_features_train, original_features_test, features_train, features_test, labels_train, labels_test, vectorizer = preprocessData()
